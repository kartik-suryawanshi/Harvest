      ...
      <div className="container mx-auto px-4 md:px-6 py-3 md:py-4">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4">
            {/* Branding */}
            <Link to="/" className="flex items-start gap-2 md:gap-3 hover:opacity-80 transition-opacity">
          ...
          {/* Navigation Links */}
          <nav className="flex items-center gap-1 border-t border-border/50 pt-3">
            {navLinks.map((link) => {
